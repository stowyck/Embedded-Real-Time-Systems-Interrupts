...
//static uint32_t I2C_Start (LPC_I2C_TypeDef *I2Cx); //MOVED TO HEADER FOR FREERTOS

/* Generate a stop condition on I2C bus (in master mode only) */
//static void I2C_Stop (LPC_I2C_TypeDef *I2Cx); //MOVED TO HEADER FOR FREERTOS
...
/* I2C set clock (hz) */
//static void I2C_SetClock (LPC_I2C_TypeDef *I2Cx, uint32_t target_clock); //MOVED TO HEADER FOR FREERTOS
